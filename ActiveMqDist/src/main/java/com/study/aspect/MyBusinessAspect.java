...
//    public void subscriberMqServicePointCut() {}
    ...
    @Pointcut("execution(* com.study.routingimpl.subscriber.*.*(..))")
    public void subscriberRoutingPointCut() {}

    @Pointcut("execution(* com.study.routingimpl.integral.*.*(..))")
    public void integralRoutingPointCut() {}
...
//            logger.info("set db is null");
    ...
    @Before("integralRoutingPointCut()")
...
//            logger.info("set db is DATA_SOURCE_INTE");
    ...
    @Before("subscriberRoutingPointCut()")
...
//            logger.info("set db is DATA_SOURCE_SUB");
    ...
    @After("subscriberRoutingPointCut()")
